...
public class TbusuariosFacadeREST extends AbstractFacade<Tbusuarios> {
    ...
    @Transactional
    public Tbusuarios insertar(Tbusuarios entity) {
    ...
    @Produces({MediaType.APPLICATION_JSON})
    @Transactional
    public Tbusuarios modificar(@PathParam("id") String id, Tbusuarios entity) {
        Tbusuarios obj= new Tbusuarios();
        super.edit(entity);
        em.flush();
        obj = entity;
    ...
    @Path("{id}")
    @Produces({MediaType.APPLICATION_JSON})
    public Tbusuarios find(@PathParam("id") String id) {
